...
class ArimaFD3Detector(AnomalyDetector):
    def __init__(self, *args, **kwargs):
        super(ArimaFD3Detector, self).__init__(*args, **kwargs)
    ...
    def run(self):
        ...
        ts_anomaly = ad.proc_tensor(metric_index=3, window=int(ts.shape[0]/2))
