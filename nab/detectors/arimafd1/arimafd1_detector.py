...
class ArimaFD1Detector(AnomalyDetector):
    def __init__(self, *args, **kwargs):
        super(ArimaFD1Detector, self).__init__(*args, **kwargs)
    ...
    def run(self):
        ...
        ts_anomaly = ad.proc_tensor(metric_index=1, window=int(ts.shape[0]/2))
