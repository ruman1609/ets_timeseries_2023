...
if __name__ == "__main__":
  ...
  if "arimaFD1" in args.detectors:
    from nab.detectors.arimafd1.arimafd1_detector import ArimaFD1Detector
  if "arimaFD2" in args.detectors:
    from nab.detectors.arimafd2.arimafd2_detector import ArimaFD2Detector
  if "arimaFD3" in args.detectors:
    from nab.detectors.arimafd3.arimafd3_detector import ArimaFD3Detector
  if "arimaFD4" in args.detectors:
    from nab.detectors.arimafd4.arimafd4_detector import ArimaFD4Detector
  if "arimaFD5" in args.detectors:
    from nab.detectors.arimafd5.arimafd5_detector import ArimaFD5Detector
  if "arimaFD6" in args.detectors:
    from nab.detectors.arimafd6.arimafd6_detector import ArimaFD6Detector
